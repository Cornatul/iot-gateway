...
/* OTAA para*/
uint8_t devEui[] = { 0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x05, 0xCA, 0x61 };
uint8_t appEui[] = { 0xB8, 0x27, 0xEB, 0xFF, 0xFE, 0x3D, 0xA0, 0x93 };
uint8_t appKey[] = { 0x9C, 0xE4, 0xD8, 0xA9, 0x9B, 0xA7, 0xED, 0x46, 0x28, 0xDF, 0x4D, 0xE7, 0x43, 0x34, 0xF0, 0x16 };
